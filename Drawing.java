...
public class Drawing
{
    ...
    public void draw(){
        ...
        //this creates the square which is the best square that eastimates the reach zone//
        //this isn't exactly acurate as the actual reach zone isn't one box//
        UI.setColor(Color.black);
        UI.drawLine(160,130,465,130);
        UI.drawLine(160,220,465,220);
        UI.drawLine(160,130,160,220);
        UI.drawLine(465,130,465,220);
    }
